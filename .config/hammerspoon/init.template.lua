...
hotKeys = {
    ...
    { { "cmd", "ctrl", "shift" }, "return", hs.grid.maximizeWindow },
    ...
    { { "cmd", "ctrl" }, "t", function() openForSpace("kitty", "New OS window") end },
    { { "cmd", "ctrl" }, "s", function() openForSpace("Safari", "New Window") end },
